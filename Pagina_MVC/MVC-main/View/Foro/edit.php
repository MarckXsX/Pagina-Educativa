...
<main>
  <div class="container py-4">
    ...
    <div class="row align-items-md-stretch">
      ...
      <div class="col-md-12">
        <div class="h-100 p-5 text-bg-dark rounded-3 ">
          <center><h1>Edicion de Foro</h1> <i class="fa-solid fa-list fa-2xl"></i></i></center>
        </div>
      </div>
    ...
    <div class="row align-items-md-stretchS py-4">
        ...
        <form role="form "action="<?= PATH ?>/Foro/update" method="POST">

            <div class="row my-2">

            <div class="form-group col-md-4 m-3">
                <label for="codigo">Codigo del Foro:</label>
                <div class="input-group my-2">
                    <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-star-of-life"></i></span>
                    <input type="text" class="form-control" readonly="true" name="ID_FORO" id="ID_FORO"  value="<?= isset($foro)?$foro['ID_FORO']:'' ?>" >
                </div>
            </div>
            ...
            <div class="form-group col-md-4 m-3">
                ...
                <div class="input-group my-2">
                    <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-star-of-life"></i></span>
                    <input type="text" class="form-control" name="Titulo" id="Titulo"  value="<?= isset($foro)?$foro['Titulo']:'' ?>" >
                </div>
            </div>
            ...
            <div class="form-group col-md-4 m-3">
                ...
                <div class="input-group my-2">
                    <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-star-of-life"></i></span>
                    <input type="text" class="form-control" name="Descripcion" id="Descripcion" value="<?= isset($foro)?$foro['Descripcion']:'' ?>" >
                </div>
            </div>
            ...
            <a class="btn btn-danger" href="<?= PATH ?>/Foro/Administracion">Cancelar</a>
