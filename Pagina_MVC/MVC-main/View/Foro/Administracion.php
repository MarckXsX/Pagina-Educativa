      ...
      <div class="col-md-12">
        <div class="h-100 p-5 text-bg-dark rounded-3 ">
          <center>
            ...
            <!-- <iframe src="https://www.youtube.com/watch?v=-s_MRTDLhnI" width="640" height="480" allow="autoplay"></iframe> -->
          ...
          <div class="d-flex justify-content-around">
            <a type="button" class="btn btn-light" href="<?=PATH?>/Foro/create"><i class="fa-solid fa-blog fa-lg"></i></i></i> Nuevo Foro</a>
        ...
        <table class="table table-striped table-bordered table-hover table-responsive table-condensed" id="tabla" style="margin-top:20px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <a type="button" class="btn btn-primary m-2" href="<?= PATH.'/Foro/edit/'.$foro['ID_FORO']?>"><i class="fa-solid fa-pen-to-square"></i> Editar</a>
                          <a type="button" class="btn btn-danger" href="<?= PATH ?>/Foro/remove/<?= $foro['ID_FORO'] ?>"><i class="fa-solid fa-delete-left"></i> Eliminar</button>
