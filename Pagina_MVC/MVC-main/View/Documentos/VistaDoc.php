        ...
        <header class="masthead text-center" style="background-color: #292828; padding-top: calc(10rem + 55px); padding-bottom: 8rem;">
            <div class="masthead-content">
                <div class="container px-5 ">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="card-title masthead-heading mb-0"><?=$documento['Nombre']?></h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="scroll" style="background-color: #343434;">
            <div class="container p-5 ">
                ...
                <div class="container px-5 ">
                    <div class="card">
                        <div class="card-body" >
                            <p class="card-title masthead-heading mb-0 fs-4 py-5"><?=$documento['Descripcion']?></p>
                            <?php
                            if($documento['Tipo']=="PDF"){            
                            ?>
                            <iframe width="640" height="800" src="<?=$documento['Recurso']?>" allow="autoplay" ></iframe>
                            <?php
                            } else{ ?>
