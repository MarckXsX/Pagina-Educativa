...
<main>
  <div class="container py-4">
    ...
    <div class="row align-items-md-stretch">
      ...
      <div class="col-md-12">
        <div class="h-100 p-5 text-bg-dark rounded-3 ">
          <center><h1>Edicion Recurso</h1> <i class="fa-solid fa-book fa-2xl"></i></center>
        </div>
      </div>
    ...
    <div class="row align-items-md-stretchS py-4">
        ...
        <form role="form "action="<?= PATH ?>/Documentos/update" method="POST">
            ...
            <div class="form-group col-md-4 m-3">
                ...
                <div class="input-group my-2">
                    ...
                    <input type="text" class="form-control" readonly="true" name="ID" id="ID"  value="<?= isset($documento)?$documento['ID']:'' ?>" >
                </div>
            </div>
            ...
            <div class="form-group col-md-4 m-3">
                ...
                <div class="input-group my-2">
                    <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-star-of-life"></i></span>
                    <input type="text" class="form-control" name="Nombre" id="Nombre"  value="<?= isset($documento)?$documento['Nombre']:'' ?>" >
                </div>
            </div>
            ...
            <div class="form-group col-md-4 m-3">
              ...
              <div class="input-group my-2">
                <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-star-of-life"></i></span>
                <input type="text" class="form-control" name="Recurso" id="Recurso" placeholder="Ingrese el link del recurso" value="<?= isset($documento)?$documento['Recurso']:'' ?>" >
              </div>
            </div>
            ...
            <div class="form-group col-md-4 m-3">
              ...
              <div class="input-group my-2">
                ...
                <select class="form-select" id="Tipo" name="Tipo" aria-label="Default select example">
                  ...
                  <option value="Video" <?=isset($documento['Tipo'])? $documento['Tipo']=='Video'?'Selected':'': '' ?>>Video</option>
                  <option value="PDF" <?=isset($documento['Tipo'])?$documento['Tipo']=='PDF'?'Selected':'':'' ?>>PDF</option>
                </select>
              </div>
            </div>
            ...
            <div class="form-group col-md-12 m-3">
                ...
                <div class="input-group my-2">
                    <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-star-of-life"></i></span>
                    <textarea class="form-control" name="Descripcion" id="Descripcion" rows="3"><?= isset($documento)?$documento['Descripcion']:'' ?></textarea>
                </div>
            </div>
            ...
            <a class="btn btn-danger" href="<?= PATH ?>/Documentos/Administracion">Cancelar</a>
